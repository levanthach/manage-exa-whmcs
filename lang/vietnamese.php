 ...
 *
 * @package    WHMCS
 * @author     kienngd @ VinaCIS <kienngd@gmail.com>
...
$_LANG["accountstats"] = "Tình trạng tài khoản";
$_LANG["addfunds"] = "Thêm tiền vào tài khoản";
...
$_LANG["addmore"] = "Thêm";
$_LANG["addtocart"] = "Thêm vào giỏ hàng"; //"Add to Cart";
...
$_LANG["announcementsdescription"] = "Xem tin tức & thông báo mới nhất của chúng tôi";
$_LANG["announcementsnone"] = "Không có thông báo để hiển thị";
$_LANG["announcementsrss"] = "Xem RSS";
...
$_LANG["cartbrowse"] = "Chọn Sản phẩm &amp; Dịch vụ";
...
$_LANG["carteditproductconfig"] = "Thay đổi";
$_LANG["cartempty"] = "Giỏ hàng của bạn đang trống ";
...
$_LANG["cartproductaddonsnone"] = "Không Addons có sẵn cho các sản phẩm &amp; dịch vụ của bạn";
...
$_LANG["cartproductdomaindesc"] = "Các sản phẩm / dịch vụ mà bạn đã chọn yêu cầu một tên miền nên bạn cần nhập tên miền vào bên dưới.";
$_LANG["cartproductdomainuseincart"] = "Use a domain already in my shopping cart";
$_LANG["cartremove"] = "Xóa bỏ";
...
$_LANG["carttitle"] = "Trang đăng ký dịch vụ của Exa";
...
$_LANG["choosecurrency"] = "Ngoại tệ";
$_LANG["choosedomains"] = "Chọn tên miền";
$_LANG["clickheretologin"] = "Click vào để đăng nhập";
$_LANG["clientareaaccountaddons"] = "Account Addons";
$_LANG["clientareaactive"] = "Đang hoạt động";
...
$_LANG["clientareaaddress1"] = "Địa chỉ";
$_LANG["clientareaaddress2"] = "Quận/Huyện";
...
$_LANG["clientareacompanyname"] = "Công ty/Tổ chức";
$_LANG["clientareaconfirmpassword"] = "Xác nhận mật khẩu";
$_LANG["clientareacontactsemails"] = "Email tuỳ chọn";

$_LANG["clientareacontactsemailsgeneral"] = "Nhận e-mail về các tin tức / thông tin / thông báo từ EXA";
$_LANG["clientareacontactsemailsproduct"] = "Nhận e-mail về các chương trình khuyến mãi của EXA";
// $_LANG["clientareacontactsemailsdomain"] = "Nhận e-mail về tên miền - Thông báo gia hạn, Xác nhận đăng ký v.v...";
// $_LANG["clientareacontactsemailsinvoice"] = "Nhận e-mail về hóa đơn dịch vụ - Các hóa đơn gia hạn, nhắc nhở thanh toán v.v...";
// $_LANG["clientareacontactsemailssupport"] = "Nhận e-mail về việc gửi các yêu cầu hỗ trợ";
...
$_LANG["clientareaemails"] = "E-mail hệ thống";
...
$_LANG["clientareafirstname"] = "Họ & tên đệm";
...
$_LANG["clientareahostingaddonsview"] = "Xem theo";
$_LANG["clientareahostingamount"] = "Số tiền";
$_LANG["clientareahostingdomain"] = "Domain";
$_LANG["clientareahostingnextduedate"] = "Hạn thanh toán";
$_LANG["clientareahostingpackage"] = "Package";
$_LANG["clientareahostingregdate"] = "Ngày đăng ký";
$_LANG["clientarealastname"] = "Tên";
$_LANG["clientarealastupdated"] = "Lần cập nhật cuối";
...
$_LANG["clientareanavaddcontact"] = "Thêm mới tài khoản phụ";
$_LANG["clientareanavchangecc"] = "Change Credit Card Details";
$_LANG["clientareanavchangepw"] = "Thay đổi mật khẩu";
$_LANG["clientareanavdetails"] = "Thông tin tài khoản chính";
...
$_LANG["clientareanavservices"] = "Dịch vụ đã đăng ký";
$_LANG["clientareanavsupporttickets"] = "Hỗ trợ Tickets";
$_LANG["clientareanocontacts"] = "No Contacts Found";
$_LANG["clientareapassword"] = "Mật khẩu";
$_LANG["clientareapending"] = "Đang chờ";
...
$_LANG["clientareapostcode"] = "Mã vùng";
$_LANG["clientareaproductdetails"] = "Chi Tiết Sản Phẩm";
$_LANG["clientareaproducts"] = "Sản phẩm &amp; Dịch vụ";
$_LANG["clientareaproductsnone"] = "No Products/Services Ordered";
$_LANG["clientarearegistrationperiod"] = "Chu kỳ sử dụng"; //"Registration Period";
...
$_LANG["clientareastate"] = "Tỉnh thành";
$_LANG["clientareastatus"] = "Trạng thái";
$_LANG["clientareasuspended"] = "Tạm khoá";
$_LANG["clientareaterminated"] = "Kết thúc";
$_LANG["clientareaticktoenable"] = "Tick to enable";
$_LANG["clientareatitle"] = "Tài khoản khách hàng";
$_LANG["clientareaunlimited"] = "Unlimited";
$_LANG["clientareaupdatebutton"] = "Update";
$_LANG["clientareaupdateyourdetails"] = "Cập nhật thông tin của Quý khách";
$_LANG["clientareaused"] = "Used";
$_LANG["clientareaviewaddons"] = "Xem Addons có sẵn";
$_LANG["clientareaviewdetails"] = "View Details";
$_LANG["clientlogin"] = "Tài khoản khách hàng";
...
$_LANG["completeorder"] = "Xác nhận đăng ký";
...
$_LANG["continueshopping"] = "Tiến hành thanh toán";//"Dịch vụ khác";
...
$_LANG["email"] = "Email";
$_LANG["emptycart"] = "Xóa khỏi giỏ hàng"; //"Empty Cart";
$_LANG["existingpassword"] = "Mật khẩu hiện tại";
$_LANG["existingpasswordincorrect"] = "Mật khẩu hiện tại của bạn không đúng";
...
$_LANG["globalsystemname"] = "Trung tâm khách hàng";
...
$_LANG["invoicenumber"] = "Số hóa đơn ";
...
$_LANG["invoices"] = "Hoá đơn";
$_LANG["invoicesamount"] = "Số tiền";
$_LANG["invoicesattn"] = "ATTN";
$_LANG["invoicesbacktoclientarea"] = "&laquo; Quay lại trang quản lý";
$_LANG["invoicesbalance"] = "Số tiền còn lại";
$_LANG["invoicesbefore"] = "before";
$_LANG["invoicescancelled"] = "Đã hủy";
$_LANG["invoicescollections"] = "Collections";
$_LANG["invoicescredit"] = "Trả trước bằng tài khoản tín dụng";
$_LANG["invoicesdatecreated"] = "Ngày lập hoá đơn";
$_LANG["invoicesdatedue"] = "Ngày đáo hạn";
$_LANG["invoicesdescription"] = "Mô tả";
$_LANG["invoicesdownload"] = "Download";
$_LANG["invoiceserror"] = "An Error Occurred. Please Try Again.";
$_LANG["invoicesinvoicedto"] = "Bên mua";
...
$_LANG["invoicespayto"] = "Bên bán";
$_LANG["invoicesrefunded"] = "Đã hoàn phí";
$_LANG["invoicesstatus"] = "Trạng thái";
$_LANG["invoicessubtotal"] = "Thành tiền";
$_LANG["invoicestax"] = "Tax Due";
$_LANG["invoicestaxindicator"] = "Dịch vụ bao gồm thuế VAT và phí"; //"Indicates a taxed item.";
$_LANG["invoicestitle"] = "Hoá đơn #";
$_LANG["invoicestotal"] = "Tổng tiền";
$_LANG["invoicestransactions"] = "Giao dịch";
$_LANG["invoicestransamount"] = "Số tiền";
$_LANG["invoicestransdate"] = "Ngày giao dịch";
$_LANG["invoicestransgateway"] = "Hệ thống thanh toán";
$_LANG["invoicestransid"] = "ID giao dịch";
$_LANG["invoicestransnonefound"] = "Không có giao dịch liên quan";
$_LANG["invoicesunpaid"] = "Chưa thanh toán";
$_LANG["invoicesdraft"] = "Draft";
$_LANG["invoicesview"] = "Xem hoá đơn";
$_LANG["jobtitle"] = "Job Title";
$_LANG["kbsuggestions"] = "Gợi ý";
$_LANG["kbsuggestionsexplanation"] = "Các bài viết sau đây đã được tìm thấy trong cơ sở dữ liệu có thể trả lời câu hỏi của bạn. Vui lòng xem lại các bài viết ​​trước khi gửi yêu cầu.";
...
$_LANG["knowledgebasehelpful"] = "Bài viết này có hữu ích với bạn?";
...
$_LANG["knowledgebasepopular"] = "Các bài viết được ưa thích";
$_LANG["knowledgebaseprint"] = "In bài viết này";
$_LANG["knowledgebaserating"] = "Bình chọn:";
$_LANG["knowledgebaseratingtext"] = "Người xem đã đánh giá bài viết này hữu ích";
...
$_LANG["knowledgebasevote"] = "Điểm";
$_LANG["knowledgebasevotes"] = "Điểm";
$_LANG["knowledgebaseyes"] = "Hữu ích";
...
$_LANG["loginrememberme"] = "Nhớ mật khẩu trong lần đăng nhập tới";
$_LANG["logoutcontinuetext"] = "Nhấn vào đây để tiếp tục...";
...
$_LANG["networkissuespriority"] = "Độ ưu tiên";
...
$_LANG["networkissuesstatusinprogress"] = "Đang giải quyết";
...
$_LANG["nextpage"] = "Trang kế tiếp";
$_LANG["no"] = "No";
$_LANG["nocarddetails"] = "No existing card details on record";
$_LANG["none"] = "Không";
$_LANG["norecordsfound"] = "Dữ Liệu Không Tìm Thấy";
$_LANG["or"] = "or";
...
$_LANG["orderbillingcycle"] = "Chu kỳ sử dụng"; //"Kỳ hạn thanh toán";
...
$_LANG["orderconfigure"] = "Tùy chọn / Bổ sung"; //"Configure";
$_LANG["orderconfirmation"] = "Xác nhận đăng ký";
$_LANG["orderconfirmorder"] = "Xác nhận đơn hàng"; //"Confirm Order";
$_LANG["ordercontinuebutton"] = "Click để tiếp tục >>";
...
$_LANG["ordererrorservernohostname"] = "Vui lòng nhập hostname";
$_LANG["ordererrorservernonameservers"] = "Vui lòng nhập prefix cho cả hai nameservers";
$_LANG["ordererrorservernorootpw"] = "Vui lòng nhập mật khẩu root";
...
$_LANG["orderfinalinstructions"] = "Nếu bạn có thắc mắc về đơn hàng của bạn , hãy mở một Tickets hỗ trợ từ khu vực khách hàng của bạn và báo Mã số dịch vụ của bạn.";
...
$_LANG["ordergotoclientarea"] = "Nhấn vào đây để đi đến Tài khoản khách hàng của bạn";
...
$_LANG["ordernotes"] = "Thông tin yêu cầu thêm hoặc ghi chú";
$_LANG["ordernotesdescription"] = "Bạn có thể nhập bất kỳ ghi chú thêm thông tin mà bạn muốn đặt hàng ngay tại đây";
$_LANG["ordernowbutton"] = "Đăng ký";
$_LANG["ordernumberis"] = "Mã số dịch vụ của bạn là:";
...
$_LANG["orderpaymenttermannually"] = "12 tháng";
$_LANG["orderpaymenttermbiennially"] = "24 tháng";
...
$_LANG["orderpromovalidatebutton"] = "Kiểm tra mã";
$_LANG["orderPromoCodePlaceholder"] = "Nhập mã giảm giá";
$_LANG["orderprorata"] = "Pro Rata";
$_LANG["orderreceived"] = "Cảm ơn bạn đã đăng ký dịch vụ. Bạn sẽ nhận được một email xác nhận.";
$_LANG["orderregisterdomain"] = "Register a New Domain";
$_LANG["orderregperiod"] = "Chu kỳ sử dụng"; //"Registration Period";
$_LANG["ordersecure"] = "Thông tin của Bạn được mã hóa, gửi và xử lý qua hệ thống bảo mật để đảm bảo an toàn, IP của Bạn";
$_LANG["ordersecure2"] = "đã được lưu vào hệ thống.";
...
$_LANG["ordersubtotal"] = "Thành tiền";
...
$_LANG["ordertotalduetoday"] = "Tổng tiền";
$_LANG["ordertotalrecurring"] = "Chi phí định kỳ";
...
$_LANG["statscreditbalance"] = "Số dư hiện tại trong tài khoản";
$_LANG["statsdueinvoicesbalance"] = "Tổng tiền";
$_LANG["statsnumdomains"] = "Số lượng tên miền";
$_LANG["statsnumproducts"] = "Số lượng sản phẩm/dịch vụ";
$_LANG["statsnumreferredsignups"] = "Số giới thiệu đăng ký";
$_LANG["statsnumtickets"] = "Số yêu cầu hỗ trợ đã gửi";
...
$_LANG["supportticketsallowedextensions"] = "Định dạng được phép đính kèm";
...
$_LANG["supportticketsopentickets"] = "Yêu cầu hỗ trợ đang mở";
$_LANG["supportticketspagetitle"] = "Hỗ trợ Tickets";
$_LANG["supportticketsposted"] = "Posted";
$_LANG["supportticketsreply"] = "Trả lời";
$_LANG["supportticketsstaff"] = "Nhân viên hỗ trợ";
$_LANG["supportticketsstatus"] = "Trạng thái";
$_LANG["supportticketsstatusanswered"] = "Đã trả lời";
$_LANG["supportticketsstatusclosed"] = "Đã giải quyết";
...
$_LANG["supportticketsstatusinprogress"] = "Đang giải quyết";
$_LANG["supportticketsstatusonhold"] = "Giữ";
$_LANG["supportticketsstatusopen"] = "Đang mở";
$_LANG["supportticketssubject"] = "Tiêu đề";
$_LANG["supportticketssubmitticket"] = "Gửi Tickets";
...
$_LANG["supportticketsticketattachments"] = "File đính kèm";
$_LANG["supportticketsticketcreated"] = "Ticket đã được tạo";
$_LANG["supportticketsticketcreateddesc"] = "Ticket của bạn đã được tạo thành công. Một email đã được gửi đến địa chỉ email của bạn với các thông tin về Ticket . Nếu bạn muốn xem Ticket này bây giờ bạn có thể click vào nút bên dưới.";
$_LANG["supportticketsticketid"] = "Ticket ID";
$_LANG["supportticketsticketsubject"] = "Tiêu đề";
$_LANG["supportticketsticketsubmit"] = "Gửi ticket";
...
$_LANG["supportticketclosedmsg"] = "Yêu cầu hỗ trợ này đã được đóng lại. Bạn có thể trả lời để mở lại.";
...
$_LANG["ticketreatinggiven"] = "Bạn đánh giá câu trả lời này";
...
$_LANG["updatecart"] = "Cập nhật giỏ hàng";//"Update Cart";
...
$_LANG["usedefaultcontact"] = "Sử dụng thông tin mặc định (Xem ở trên)";
...
$_LANG["pwresetsubmit"] = "Xác nhận";
$_LANG["pwresetvalidationsent"] = "Email xác nhận đã được gửi đi"; //"Validation Email Sent";
$_LANG["pwresetvalidationcheckemail"] = "Vui lòng kiểm tra email của bạn để được hướng dẫn về những việc cần làm tiếp theo."; //"The password reset process has now been started. Please check your email for instructions on what to do next.";
...
$_LANG["pwresetvalidationsuccess"] = "Đặt lại mật khẩu thành công";//"Password Reset Successful";
...
$_LANG["subaccountactivatedesc"] = "Đánh dấu vào để cấu hình tài khoản phụ có quyền truy cập khu vực khách hàng";
...
$_LANG["knowledgebasealsoread"] = "Có thể bạn quan tâm";
$_LANG["orderpaymenttermtriennially"] = "36 tháng";
...
$_LANG["invoicestotaldue"] = "Tổng tiền";
$_LANG["masspaytitle"] = "Thanh toán";
...
$_LANG["masspayselected"] = "Chọn thanh toán";
$_LANG["masspayall"] = "Thanh toán";
$_LANG["masspaymakepayment"] = "Thanh toán";
...
$_LANG["cartdomaininvalid"] = "Tên miền bạn nhập vào không hợp lệ. Vui lòng nhập lại tên miền mà bạn muốn sử dụng cho hosting bạn sắp đăng ký (Nhập tên miền bằng ký tự thường. Ví dụ: buidoi.net)";
...
$_LANG["quote"] = "Báo giá";
$_LANG["quotestitle"] = "Báo giá của tôi";
...
$_LANG["step"] = "Step %s";
$_LANG["cartdomainexists"] = "Tên miền này đã tồn tại trên hệ thống của chúng tôi vì vậy không thể đăng ký, vui lòng điền tên miền khác";
...
$_LANG["cartfollowingaddonsavailable"] = "Các addons sau đây dành cho các sản phẩm & dịch vụ đang hoạt động của bạn .";
$_LANG["cartregisterdomainchoice"] = "Đăng ký một tên miền mới";
$_LANG["carttransferdomainchoice"] = "Chuyển tên miền của bạn từ nhà đăng ký khác";
$_LANG["cartexistingdomainchoice"] = "Sử dụng tên miền bạn đang có";
...
$_LANG["cartproductselection"] = "Lựa chọn Dịch vụ";
$_LANG["cartreviewcheckout"] = "Xác nhận đơn hàng";
$_LANG["cartchoosecycle"] = "Chọn chu kỳ thanh toán";
$_LANG["cartavailableaddons"] = "Available Addons";
$_LANG["cartsetupfees"] = "Phí cài đặt";
$_LANG["cartchooseanotherproduct"] = "Dịch vụ khác";
$_LANG["cartaddandcheckout"] = "Thanh toán";
$_LANG["cartchooseanothercategory"] = "Chọn danh mục khác";
$_LANG["carttryanotherdomain"] = "Hãy thử một tên miền khác";
$_LANG["cartmakedomainselection"] = "Vui lòng cung cấp cho chúng tôi tên miền bạn muốn sử dụng với dịch vụ hosting mà bạn muốn đăng ký bằng cách chọn một tùy chọn từ các lựa chọn dưới đây.";
$_LANG["cartfraudcheck"] = "Fraud Check";
$_LANG["newcustomer"] = "New Customer";
$_LANG["existingcustomer"] = "Existing Customer";
$_LANG["newcustomersignup"] = "<strong>Chưa đăng ký?</strong> %sClick tại đây để đăng ký...%s";
...
$_LANG["problemgoback"] = "Quay trở lại và thử lại";
$_LANG["quantity"] = "Quantity";
$_LANG["cartqtyenterquantity"] = "Vui lòng nhập số lượng tại đây nếu bạn muốn mua nhiều hơn 1";//"Want more than 1 of this item? Enter Quantity Here:";
$_LANG["cartqtyupdate"] = "Cập nhật";//"Update";
...
$_LANG["captchatitle"] = "Kiểm tra Spam Bot";
$_LANG["captchaverify"] = "Xin vui lòng nhập các ký tự hình bên dưới vào hộp văn bản được cung cấp.";
$_LANG["captchaverifyincorrect"] = "Các ký tự mà bạn nhập vào không phù hợp với hình ảnh được hiển thị. Vui lòng thử lại.";
$_LANG["googleRecaptchaIncorrect"] = "Vui lòng điền vào ký tự và thử lại.";
$_LANG["recaptcha-invalid-site-private-key"] = "Có lỗi xảy ra, xin vui lòng liên hệ với hỗ trợ (error code: cap1)";
$_LANG["recaptcha-invalid-request-cookie"] = "Có lỗi xảy ra, xin vui lòng thử lại (error code: cap2)";
$_LANG["recaptcha-incorrect-captcha-sol"] = "Các ký tự mà bạn đã nhập không khớp với xác minh từ. Vui lòng thử lại.";
...
$_LANG["navservices"] = "Quản lý dịch vụ";
$_LANG["navservicesorder"] = "Đăng ký dịch vụ mới";
$_LANG["navservicesplaceorder"] = "Đăng ký mới";
...
$_LANG["navbilling"] = "Quản lý hóa đơn";
$_LANG["navinvoices"] = "Hóa đơn";
$_LANG["navsupport"] = "Hỗ trợ";
$_LANG["navtickets"] = "Hỗ trợ";
$_LANG["navopenticket"] = "Gửi yêu cầu hỗ trợ";
$_LANG["navmanagecc"] = "Quản lý thẻ tín dụng";
$_LANG["navemailssent"] = "Lịch sử các email";
...
$_LANG["editaccountdetails"] = "Chỉnh sửa tài khoản";
$_LANG["clientareanavccdetails"] = "Thông tin chi tiết thẻ tín dụng";
$_LANG["clientareanavcontacts"] = "Quản lý tài khoản phụ";
$_LANG["manageyouraccount"] = "Thông tin tài khoản chính";
$_LANG["accountoverview"] = "Account Overview";
$_LANG["paymentmethod"] = "Phương thức thanh toán";
$_LANG["paymentmethoddefault"] = "Sử dụng thông tin mặc định";
...
$_LANG["emailviewmessage"] = "Xem nội dung";
...
$_LANG["clientareahomelogin"] = "Bạn đã có tài khoản tại Exa? Vậy, hãy nhấp vào nút bên dưới để đăng nhập và dễ dàng quản lý dịch vụ mà bạn đã đăng ký.";
...
$_LANG["registerintro"] = "Tạo một tài khoản . . .";
$_LANG["masspayintro"] = ""; //"Thanh toán tất cả các hóa đơn trong một bước";
...
$_LANG["youhaveoverdueinvoices"] = "Quý khách có %s hóa đơn chưa thanh toán";
$_LANG["overdueinvoicesdesc"] = "Để tránh hệ thống tự động khóa dịch vụ vào 9h sáng, quý khách nên thanh toán hóa đơn sớm. Nhấp vào nút kế bên để chọn các hình thức thanh toán %sThanh toán &raquo;%s";
...
$_LANG["pwstrength"] = "Độ mạnh mật khẩu";
...
$_LANG["information"] = "Thông tin dịch vụ";
...
$_LANG["networkstatustitle"] = "Tình trạng máy chủ";
$_LANG["networkstatusnone"] = "Không có vấn đề %s hiện nay";
...
$_LANG["opennewticket"] = "Gửi yêu cầu hỗ trợ";
$_LANG["searchtickets"] = "Enter Ticket # or Subject";
$_LANG["supportticketspriority"] = "Độ ưu tiên";
$_LANG["supportticketsubmitted"] = "Ngày gửi";
$_LANG["supportticketscontact"] = "Contact";
$_LANG["supportticketsticketlastupdated"] = "Trả lời lần cuối";
...
$_LANG["supportticketsclose"] = "Đã giải quyết";
$_LANG["affiliatesinitialthen"] = "Initially then";
$_LANG["invoicesoutstandingbalance"] = "Outstanding Balance";
$_LANG["cpanellogin"] = "Đăng nhập cPanel";
$_LANG["cpanelwhmlogin"] = "Đăng nhập WHM";
$_LANG["cpanelwebmaillogin"] = "Đăng nhập Webmail";
...
$_LANG["directadminlogin"] = "Đăng nhập DirectAdmin";
...
$_LANG["pwresetsuccessdesc"] = "Mật khẩu của bạn hiện đã được đặt lại. %sNhấn vào đây%s để trở lại khu vực khách hàng";//"Your password has now been reset. %sClick here%s to continue to the client area...";
...
$_LANG["returnclient"] = "Trở về giao diện quản lý"; //"Return to Client Area";
$_LANG["clientareanavsecurity"] = "Cài đặt bảo mật"; //"Thay đổi câu hỏi bảo mật";
...
$_LANG["domaincontactdetails"]["First Name"] = "Họ & tên đệm";
$_LANG["domaincontactdetails"]["Last Name"] = "Tên";
...
$_LANG["domaincontactdetails"]["Address 1"] = "Địa chỉ";
$_LANG["domaincontactdetails"]["Address 2"] = "Quận/Huyện";
...
$_LANG["sidebars"]["viewAccount"]["securitySettings"] = "Cấu hình bảo mật"; //"Thay đổi câu hỏi bảo mật";
...
$_LANG["invoicesdue"] = "Hóa đơn";
$_LANG["invoicesduemsg"] = "Bạn có %s hoá đơn chưa thanh toán hiện tại với tổng số tiền là %s";
$_LANG["noinvoicesduemsg"] = "Bạn không có hoá đơn chưa thanh toán tại thời điểm này.";
...
$_LANG["overview"] = "Xem thông tin";
$_LANG["visitwebsite"] = "Đi đến trang web";
$_LANG["whoisinfo"] = "WHOIS Info";
$_LANG["tableshowing"] = "Đang xem _START_ đến _END_ trong số _TOTAL_ mục";
$_LANG["tableempty"] = "Đang xem 0 đến 0 trong số 0 mục";
$_LANG["tablefiltered"] = "(filtered from _MAX_ total entries)";
$_LANG["tablelength"] = "Kết quả trên trang _MENU_";
$_LANG["tableloading"] = "Loading...";
$_LANG["tableprocessing"] = "Processing...";
$_LANG["tablepagesfirst"] = "First";
$_LANG["tablepageslast"] = "Last";
$_LANG["tablepagesnext"] = "Trang kế tiếp";
$_LANG["tablepagesprevious"] = "Trang trước";
$_LANG["tableviewall"] = "Không giới hạn";
$_LANG["tableentersearchterm"] = "Mã hỗ trợ hoặc tiêu đề...";
$_LANG["actions"] = "Thao tác";
$_LANG["upgradedowngradeshort"] = "Up/Downgrade";
$_LANG["masspaymentselectgateway"] = "Chọn cổng thanh toán";
...
$_LANG["homebegin"] = "Bắt đầu tìm kiếm một tên miền mà bạn đã nghĩ...";
$_LANG["howcanwehelp"] = "Bạn đang cần hỗ trợ gì?";
$_LANG["exampledomain"] = "eg. yourdomain.com";
$_LANG["buyadomain"] = "Mua một tên miền";
$_LANG["orderhosting"] = "Đăng ký dịch vụ";
$_LANG["makepayment"] = "Thanh toán";
$_LANG["getsupport"] = "Hỗ trợ";
$_LANG["news"] = "Thông báo";
$_LANG["allthelatest"] = "Tất cả thông báo từ";
$_LANG["readmore"] = "Xem tiếp";
$_LANG["noannouncements"] = "Không có thông báo để hiển thị";
$_LANG["kbsearchexplain"] = "Có điều muốn hỏi? Bắt đầu tìm kiếm của bạn ở đây.";
$_LANG["readyforquestions"] = "Chúng tôi đã sẵn sàng trả lời câu hỏi của bạn";
$_LANG["restrictedpage"] = "Trang này được bảo mật";
$_LANG["enteremail"] = "Nhập email";
$_LANG["passwordtips"] = "<strong>Lời khuyên cho một mật khẩu bảo mật</strong><br />Sử dụng cả ký tự in hoa & ký tự thường<br />Bao gồm ít nhất một ký tự đặc biệt (# $ ! % &amp; etc...)<br />Không sử dụng mật khẩu quá đơn giản";
...
$_LANG["ticketsyourhistory"] = ""; //"Lịch sử ticket của bạn";
$_LANG["clientareaemaildesc"] = ""; //"Lịch sử các Email của bạn";
...
$_LANG["adminmasqueradingasclient"] = "Bạn đang đăng nhập như là một khách hàng.";
$_LANG["logoutandreturntoadminarea"] = "Thoát và quay lại trang quản lý";
...
$_LANG["pwresetemailneeded"] = "Quên mật khẩu của bạn? Nhập địa chỉ email của bạn dưới đây để bắt đầu quá trình thiết lập lại.";
...
$_LANG["yourrecenttickets"] = "Tickets của bạn gần đây";
...
$_LANG["error"] = "Error";
$_LANG["print"] = "Print";
$_LANG["invoicelineitems"] = "Thanh toán Sản phẩm/Dịch vụ";
...
$_LANG["clientAlerts"]["invoicesUnpaid"] = "Bạn có :numberOfInvoices hóa đơn chưa thanh toán.";
$_LANG["clientAlerts"]["invoicesOverdue"] = "Bạn có :numberOfInvoices hóa đơn chưa thanh toán với tổng số tiền là :balanceDue.";
$_LANG["clientAlerts"]["creditBalance"] = "You have a credit balance of :creditBalance.";
$_LANG["clientHomePanels"]["unpaidInvoices"] = "Hoá đơn chưa thanh toán";
$_LANG["clientHomePanels"]["unpaidInvoicesMsg"] = "Bạn có :numberOfInvoices hóa đơn chưa thanh toán với tổng số nợ là :balanceDue. ";
$_LANG["clientHomePanels"]["overdueInvoices"] = "Hoá đơn quá hạn";
$_LANG["clientHomePanels"]["overdueInvoicesMsg"] = "Bạn có :numberOfInvoices hóa đơn quá hạn với tổng số tiền cần phải thanh toán là :balanceDue . Thanh toán ngay bây giờ để tránh bất kỳ sự gián đoạn trong dịch vụ.";
...
$_LANG["clientHomePanels"]["activeProductsServices"] = "Sản phẩm/Dịch vụ đang hoạt động";
$_LANG["clientHomePanels"]["activeProductsServicesNone"] = "Có vẻ như bạn không có bất kỳ sản phẩm / dịch vụ nào với chúng tôi. <a href=\"cart.php\">Đăng ký ngay bây giờ</a>.";
$_LANG["clientHomePanels"]["recentNews"] = "Tin tức từ Exa";
$_LANG["clientHomePanels"]["affiliateProgram"] = "Affiliate Program";
$_LANG["clientHomePanels"]["recentSupportTickets"] = "Các yêu cầu hỗ trợ gần đây";
$_LANG["clientHomePanels"]["recentSupportTicketsNone"] = "Không có Tickets gần đây. Nếu bạn cần bất kỳ sự trợ giúp , xin vui lòng <a href=\"submitticket.php\">Gửi yêu cầu hỗ trợ</a>.";
...
$_LANG["clientHomeSearchKb"] = "Nhập một câu hỏi tại đây để tìm kiếm hướng dẫn của chúng tôi...";
...
$_LANG["cPanel"]["usageLastUpdated"] = "Lần cập nhật cuối";
...
$_LANG["billingAddress"] = "Thông tin thanh toán"; //"Billing Address";
...
$_LANG["orderForm"]["returnToClientArea"] = "Trở về giao diện quản lý"; //"Return to Client Area";
$_LANG["orderForm"]["checkout"] = "Thanh Toán";
$_LANG["orderForm"]["alreadyRegistered"] = "Đã có tài khoản"; //"Already Registered?";
$_LANG["orderForm"]["createAccount"] = "Tạo tài khoản mới"; //"Create a New Account";
$_LANG["orderForm"]["enterPersonalDetails"] = "Vui lòng nhập thông tin cá nhân / thông tin thanh toán  chính xác, đầy đủ để EXA thuận tiện trong quá trình làm hợp đồng dịch vụ cho Quý khách"; //"Please enter your personal details and billing information to checkout.";
...
$_LANG["orderForm"]["personalInformation"] = "Thông tin cá nhân"; //"Personal Information";
...
$_LANG["orderForm"]["preferredPaymentMethod"] = "Vui lòng chọn phương thức thanh toán."; //"Please choose your preferred method of payment.";
$_LANG["orderForm"]["cardNumber"] = "Card Number";
$_LANG["orderForm"]["cvv"] = "CVV Security Number";
$_LANG["orderForm"]["additionalNotes"] = "Ghi chú"; //"Additional Notes";
...
$_LANG["orderForm"]["addToCart"] = "Thêm vào giỏ hàng"; //"Add to Cart";
...
$_LANG["orderForm"]["productOptions"] = "Sản phẩm dịch vụ";
$_LANG["orderForm"]["qty"] = "Qty";
$_LANG["orderForm"]["priceCycle"] = "Thời hạn";
$_LANG["orderForm"]["edit"] = "Edit";
$_LANG["orderForm"]["update"] = "Cập nhật";//"Update";
...
$_LANG["orderForm"]["errorNoProducts"] = "Hiện tại chưa có sản phẩm cho dịch vụ này"; //"Product group does not contain any visible products";
...
$_LANG["navStore"] = "Sản phẩm";
$_LANG["navBrowseProductsServices"] = "Tất cả";
...
$_LANG["dateTime"]["am"] = "am";
$_LANG["dateTime"]["pm"] = "pm";
$_LANG["emailMarketing"]["joinOurMailingList"] = "Nhận Email từ EXA"; //"Join our mailing list";
$_LANG["edit"] = "Edit";
...
////////// End of Vietnamese language file.  Do not place any translation strings below this line!
