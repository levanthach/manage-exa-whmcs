			...
			<div class="row">
				<div class="col-sm-6">
					...
					<div class="form-group prepend-icon">
						...
						<input type="text" name="firstname" id="inputFirstName" value="{$contactfirstname}" class="form-control field" placeholder="{$LANG.clientareafirstname}"/>
					</div>
					...
					<div class="form-group prepend-icon">
						...
						<input type="text" name="companyname" id="inputCompanyName" value="{$contactcompanyname}" class="form-control field" placeholder="{$LANG.clientareacompanyname}"/>
					</div>
					...
					<div class="form-group prepend-icon">
						...
						<input type="email" name="email" id="inputEmail" value="{$contactemail}" class="form-control field" placeholder="{$LANG.clientareaemail}"/>
					</div>
					...
					<div class="form-group prepend-icon">
						...
						<input type="tel" name="phonenumber" id="inputPhone" value="{$contactphonenumber}" class="form-control field" placeholder="{$LANG.clientareaphonenumber}"/>
					</div>
				...
				<div class="col-sm-6 col-xs-12 pull-right">
					<div class="form-group prepend-icon">
						...
						<input type="text" name="lastname" id="inputLastName" value="{$contactlastname}" class="form-control field" placeholder="{$LANG.clientarealastname}"/>
					</div>
					...
					<div class="form-group prepend-icon">
						...
						<input type="text" name="address1" id="inputAddress1" value="{$contactaddress1}" class="form-control field" placeholder="{$LANG.clientareaaddress1}"/>
					</div>
					...
					<div class="form-group prepend-icon">
						...
						<input type="text" name="address2" id="inputAddress2" value="{$contactaddress2}" class="form-control field" placeholder="{$LANG.clientareaaddress2}"/>
					</div>
					{/if}
					...
					<div class="form-group prepend-icon">
						...
						<input type="text" name="state" id="inputState" value="{$contactstate}" class="form-control field" placeholder="{$LANG.clientareastate}"/>
					</div>
					...
					<div class="form-group prepend-icon">
						...
						<input type="text" name="city" id="inputCity" value="{$contactcity}" class="form-control field" placeholder="{$LANG.clientareacity}"/>
					</div>

					{if 1==2}
					<div class="form-group prepend-icon">
						<label for="inputPostcode" class="control-label field-icon">
							<span class="glyphicon glyphicon-tree-deciduous"></span>
						</label>
						<input type="text" name="postcode" id="inputPostcode" value="{$contactpostcode}" class="form-control field" placeholder="{$LANG.clientareapostcode}"/>
					</div>
					{/if}
				...
				<div id="subacct-container" class="well{if !$subaccount} hidden{/if}">
					...
					<fieldset class="form-horizontal">
						<div id="newPassword1" class="form-group has-feedback">
							<div class="col-sm-12">
								<input type="password" class="form-control" id="inputNewPassword1" name="password" placeholder="{$LANG.newpassword}"/>
						...
						<div id="newPassword2" class="form-group has-feedback">
							<div class="col-sm-12">
								<input type="password" class="form-control" id="inputNewPassword2" name="password2" placeholder="{$LANG.confirmnewpassword}"/>
								<span class="form-control-feedback glyphicon glyphicon-lock"></span>
