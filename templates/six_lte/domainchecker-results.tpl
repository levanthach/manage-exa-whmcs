    ...
    {if ($searchResults && !$searchResults.isRegistered) || $bulkCheckResults}
        ...
        <div class="domainresults" id="primarySearchResults">
            <div id="btnCheckout" class="domain-checkout-area">
                <a style="background-color:#970001;color:#fff" href="{$WEB_ROOT}/cart.php?a=confdomains" class="btn btn-default">{$LANG.domainsgotocheckout} &raquo;</a>
            </div>
            <div>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                {if count($searchResults.pricing) == 1}
                                     ...
                                     {if $searchResults.tld eq  'gov.vn' }
                                          <span style="color:red">Liên hệ để đăng ký</span> 
                                        {else}
                                ...
                                {else}
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-primary btn-sm btn-addtocart-exa" onclick="addToCart(this, false, 'register')">
    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="domainresults" id="suggestionSearchResults">
                ...
                <div>
                    {$LANG.domainssuggestions} <span></span>
                </div>
            ...
            <div class="domain-disclaimer-area">
                <p class="text-muted"><strong> </strong><br /> </p>
            </div>
        </div>
    </div>
