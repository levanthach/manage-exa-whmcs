                ...
                <div class="col-md-8 col-md-offset-2 col-xs-10 col-xs-offset-1">
                    {if $bulkdomainsearchenabled}
                        <div class="domain-bulk-options-box hidden-xs">
                            <a href="{$WEB_ROOT}/domainchecker.php?search=bulk" id="btnBulkOptions" class="btn btn-danger btn-sm" />{$LANG.bulkoptions}</a>
                        </div>
                    {/if}
                    <div class="input-group input-group-lg input-group-box">
                        <input type="text" class="form-control" placeholder="{$LANG.findyourdomain}" value="{$domain}" id="inputDomain" />
                        <span class="input-group-btn">
                            <button type="submit" id="btnCheckAvailability" class="btn btn-success domain-check-availability">{$LANG.search}</button>
                        </span>
                    </div>
                </div>
            </div>
    ...
    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
        ...
        <div class="panel panel-danger">
            ...
            <div id="collapseAll" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingAll">
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12 col-md-offset-0 col-lg-12 col-lg-offset-0 table-responsive domain-tld-pricing-table-responsive">
                            <table class="table table-striped table-framed tld-pricing-tv">
                                <thead>
                                    <tr>
                                        <th class="text-center">{$LANG.domaintld}</th>
                                        <th class="text-center">{$LANG.domainminyears}</th>
...
<script src="{$WEB_ROOT}/templates/{$template}/js/domainchecker.js"></script>
...
{include file="$template/includes/modal.tpl" name="AlreadyInCart" title="{$LANG.domainchecker.alreadyincarttitle}" content="{$LANG.domainchecker.alreadyincartmsg}" submitAction="window.location='{$WEB_ROOT}/cart.php?a=checkout'" submitLabel="{$LANG.domainchecker.alreadyincartcheckoutnow}"}
