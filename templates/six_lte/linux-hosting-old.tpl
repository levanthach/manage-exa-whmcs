        ...
        <div class="price_table">
          <div class="plan_info">
            ...
            <ul class="plan_features two">
			  ...
			  <li>10 Mailbox</li>
			<li><p class="padd_bot1">Lựa chọn gói:</p>
              ...
              <label class="custom-select3">
                <select id="duration-7" class="select_cloud_hosting">
                  ...
                  <option value="annually" selected>12 tháng &nbsp;708.000 Đ/tháng</option>
                  <option value="biennially">24 tháng &nbsp;1.416.000 Đ/tháng</option>
                </select>
              </label>
            </div>
              </li>
            </ul>
            <a  onclick="submitpage_pack(7,'/cart.php?a=add&pid=7'); return false;" class="singup_but" href="#">Đặt mua</a> </div>
        </div>
        <!--end item-->
      ...
      <div class="one_fourth">
        ...
        <div class="price_table">
          <div class="plan_info">
            ...
            <a class="singup_but" href="javascript:void(0);" onclick="submitpage_pack(12,'/cart.php?a=add&pid=12'); return false;" >Đặt mua</a> </div>
        </div>
        <!--end item-->
        <div class="arrow_down"></div>
      </div>
      ...
      <div class="one_fourth">
        ...
        <div class="price_table">
          <div class="plan_info">
            ...
            <a class="singup_but" href="javascript:void(0);"  onclick="submitpage_pack(13,'/cart.php?a=add&pid=13'); return false;" >Đặt mua</a> </div>
        </div>
        <!--end item-->
        <div class="arrow_down"></div>
      </div>
      ...
      <div class="one_fourth">
        ...
        <div class="price_table">
          <div class="plan_info">
            ...
            <a class="singup_but" href="javascript:void(0);" onclick="submitpage_pack(14,'/cart.php?a=add&pid=14'); return false;">Đặt mua</a> </div>
        </div>
	  ...
	  <div class="one_fourth last">
        ...
        <div class="price_table">
          <div class="plan_info">
            ...
            <a class="singup_but" href="javascript:void(0);" onclick="submitpage_pack(15,'/cart.php?a=add&pid=15'); return false;" >Đặt mua</a> </div>
        </div>
        <!--end item-->
        <div class="arrow_down"></div>
      </div>
